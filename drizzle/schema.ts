...
export const tabelasComissao = mysqlTable("tabelasComissao", {
  ...
  ativo11: varchar("ativo11", { length: 20 }),
  ativo11De: varchar("ativo11De", { length: 20 }),
  ativo11Ate: varchar("ativo11Ate", { length: 20 }),
  ativo12: varchar("ativo12", { length: 20 }),
  ativo12De: varchar("ativo12De", { length: 20 }),
  ativo12Ate: varchar("ativo12Ate", { length: 20 }),
  ativo13: varchar("ativo13", { length: 20 }),
  ativo13De: varchar("ativo13De", { length: 20 }),
  ativo13Ate: varchar("ativo13Ate", { length: 20 }),
  ativo14: varchar("ativo14", { length: 20 }),
  ativo14De: varchar("ativo14De", { length: 20 }),
  ativo14Ate: varchar("ativo14Ate", { length: 20 }),
  ativo15: varchar("ativo15", { length: 20 }),
  ativo15De: varchar("ativo15De", { length: 20 }),
  ativo15Ate: varchar("ativo15Ate", { length: 20 }),
  ativo16: varchar("ativo16", { length: 20 }),
  ativo16De: varchar("ativo16De", { length: 20 }),
  ativo16Ate: varchar("ativo16Ate", { length: 20 }),
  ativo17: varchar("ativo17", { length: 20 }),
  ativo17De: varchar("ativo17De", { length: 20 }),
  ativo17Ate: varchar("ativo17Ate", { length: 20 }),
  ativo18: varchar("ativo18", { length: 20 }),
  ativo18De: varchar("ativo18De", { length: 20 }),
  ativo18Ate: varchar("ativo18Ate", { length: 20 }),
  ativo19: varchar("ativo19", { length: 20 }),
  ativo19De: varchar("ativo19De", { length: 20 }),
  ativo19Ate: varchar("ativo19Ate", { length: 20 }),
  ativo20: varchar("ativo20", { length: 20 }),
  ativo20De: varchar("ativo20De", { length: 20 }),
  ativo20Ate: varchar("ativo20Ate", { length: 20 }),
...
export const valoresCalculo = mysqlTable("valoresCalculo", {
  ...
  ativo11: decimal("ativo11", { precision: 10, scale: 2 }).default("0.00"),
  ativo11De: decimal("ativo11De", { precision: 15, scale: 2 }),
  ativo11Ate: decimal("ativo11Ate", { precision: 15, scale: 2 }),
  ativo12: decimal("ativo12", { precision: 10, scale: 2 }).default("0.00"),
  ativo12De: decimal("ativo12De", { precision: 15, scale: 2 }),
  ativo12Ate: decimal("ativo12Ate", { precision: 15, scale: 2 }),
  ativo13: decimal("ativo13", { precision: 10, scale: 2 }).default("0.00"),
  ativo13De: decimal("ativo13De", { precision: 15, scale: 2 }),
  ativo13Ate: decimal("ativo13Ate", { precision: 15, scale: 2 }),
  ativo14: decimal("ativo14", { precision: 10, scale: 2 }).default("0.00"),
  ativo14De: decimal("ativo14De", { precision: 15, scale: 2 }),
  ativo14Ate: decimal("ativo14Ate", { precision: 15, scale: 2 }),
  ativo15: decimal("ativo15", { precision: 10, scale: 2 }).default("0.00"),
  ativo15De: decimal("ativo15De", { precision: 15, scale: 2 }),
  ativo15Ate: decimal("ativo15Ate", { precision: 15, scale: 2 }),
  ativo16: decimal("ativo16", { precision: 10, scale: 2 }).default("0.00"),
  ativo16De: decimal("ativo16De", { precision: 15, scale: 2 }),
  ativo16Ate: decimal("ativo16Ate", { precision: 15, scale: 2 }),
  ativo17: decimal("ativo17", { precision: 10, scale: 2 }).default("0.00"),
  ativo17De: decimal("ativo17De", { precision: 15, scale: 2 }),
  ativo17Ate: decimal("ativo17Ate", { precision: 15, scale: 2 }),
  ativo18: decimal("ativo18", { precision: 10, scale: 2 }).default("0.00"),
  ativo18De: decimal("ativo18De", { precision: 15, scale: 2 }),
  ativo18Ate: decimal("ativo18Ate", { precision: 15, scale: 2 }),
  ativo19: decimal("ativo19", { precision: 10, scale: 2 }).default("0.00"),
  ativo19De: decimal("ativo19De", { precision: 15, scale: 2 }),
  ativo19Ate: decimal("ativo19Ate", { precision: 15, scale: 2 }),
  ativo20: decimal("ativo20", { precision: 10, scale: 2 }).default("0.00"),
  ativo20De: decimal("ativo20De", { precision: 15, scale: 2 }),
  ativo20Ate: decimal("ativo20Ate", { precision: 15, scale: 2 }),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
});
