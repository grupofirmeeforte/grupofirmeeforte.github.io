    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="bg-gray-900 border-b border-gray-700 px-4 py-2 flex items-center gap-3 flex-wrap">
        <div className="relative">
          <Search className="absolute left-2 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-800" />
          <Input
      ...
      {showConfig && (
        <div className="w-72 min-w-[18rem] bg-white border-r shadow-sm flex-shrink-0 p-4 space-y-4">
          <h3 className="text-sm font-bold text-gray-800">Configuração de Comissão</h3>
          ...
          <div className="border border-green-200 rounded-lg p-3 bg-green-50">
            ...
            <div className="space-y-2">
              <div>
                <label className="text-xs text-gray-800">Padrão (R$)</label>
                <div className="flex items-center gap-1 mt-1">
                  <span className="text-xs text-gray-800 font-medium">R$</span>
                  <Input
          ...
          <div className="border border-blue-200 rounded-lg p-3 bg-blue-900/20">
            ...
            <div className="space-y-2">
              <div>
                <label className="text-xs text-gray-800">Especial (R$)</label>
                <div className="flex items-center gap-1 mt-1">
                  <span className="text-xs text-gray-800 font-medium">R$</span>
                  <Input
                    className="h-7 text-sm w-full"
              ...
              <div>
                <label className="text-xs text-gray-800">Agentes com comissão especial</label>
                <textarea
                ...
                />
                <p className="text-xs text-gray-800 mt-1">Digite um ChaveJ por linha para cálculo.</p>
              </div>
            </div>
          </div>
                  ...
                  >
                    ...
                    <td className="px-2 py-1.5">
                      <div className="flex items-center gap-1.5 mb-0.5">
                        ...
                        <span className="text-[9px] text-gray-800">{r.mesAno || ""}</span>
                      </div>
                    ...
                    {/* Coluna Conta */}
                    <td className="px-2 py-1.5">
                      <div className="text-[11px] text-gray-800">Ag: {r.agencia || "-"} · Cc: {r.contaCorrente || "-"}</div>
                    ...
                    <td className="px-2 py-1.5 text-right whitespace-nowrap">
                      ...
                      <div className="text-[10px] text-gray-800">RBM: {fmtMoeda(r.rbm)}</div>
                    </td>
                    <td className="px-2 py-1.5 text-center" onClick={e => e.stopPropagation()}>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <div className="text-xs text-gray-800 mt-1">Adiciona somente registros novos.</div>
              </button>
              <button
              ...
              >
                ...
                <div className="text-xs text-gray-800 mt-1">Adiciona todos os registros (pode duplicar).</div>
              </button>
            </div>
            <div>
