    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      {showConfig && (
        <div className="w-72 min-w-[18rem] bg-white border-r shadow-sm flex-shrink-0 p-4 space-y-4">
          <h3 className="text-sm font-bold text-gray-900">Configuração de Comissão</h3>
          ...
          <div className="border border-blue-200 rounded-lg p-3 bg-blue-900/20">
            ...
            <div className="space-y-2">
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-900 mt-1">Digite um ChaveJ por linha para cálculo.</p>
              </div>
            </div>
          </div>
                  ...
                  >
                    ...
                    <td className="px-2 py-1.5">
                      <div className="flex items-center gap-1.5 mb-0.5">
                        ...
                        <span className="text-[9px] text-gray-900">{r.mesAno || ""}</span>
                      </div>
                    ...
                    <td className="px-2 py-1.5 text-right whitespace-nowrap">
                      ...
                      <div className="text-[10px] text-gray-900">RBM: {fmtMoeda(r.rbm)}</div>
                    </td>
                    <td className="px-2 py-1.5 text-center" onClick={e => e.stopPropagation()}>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <div className="text-xs text-gray-900 mt-1">Adiciona somente registros novos.</div>
              </button>
              <button
              ...
              >
                ...
                <div className="text-xs text-gray-900 mt-1">Adiciona todos os registros (pode duplicar).</div>
              </button>
            </div>
            <div>
