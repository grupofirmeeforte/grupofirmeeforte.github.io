    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap gap-2 items-center">
        <div className="relative">
          <Search className="absolute left-2 top-2 w-3.5 h-3.5 text-gray-800" />
      ...
      <div className="overflow-auto border rounded" style={{ maxHeight: 'calc(100vh - 280px)' }}>
        <table className="w-full text-[10px] border-collapse" style={{ tableLayout: 'auto' }}>
          ...
          <tbody>
            ...
            {rows.length === 0 && (
              <tr><td colSpan={13} className="text-center py-4 text-gray-800">Nenhum documento encontrado</td></tr>
            )}
          </tbody>
        </table>
      </div>
