                ...
                <div className="relative">
                  ...
                  {!isAgenteProtegido && (
                    <button
                      ...
                      className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-800 hover:text-gray-600"
                      tabIndex={-1}
                    >
          ...
          <Card className="border-2 border-indigo-200 bg-indigo-50/30">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-4 pb-4 border-b border-indigo-200">
                ...
                <span className="text-xs text-slate-800">Usado como padrão quando não há permissão específica por sub-aba</span>
              </div>
