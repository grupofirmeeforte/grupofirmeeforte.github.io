    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="bg-gray-900 border-b border-gray-700 px-4 py-2 flex flex-wrap gap-2">
        <div className="relative">
          <Search className="absolute left-2 top-2 w-4 h-4 text-gray-800" />
          <Input
        ...
        <table className="w-full text-xs border-collapse">
          ...
          <tbody>
            {isLoading ? (
              ...
              <tr><td colSpan={6} className="text-center py-8 text-gray-800">Nenhum registro encontrado</td></tr>
            ) : rows.map((row, i) => (
              <tr key={row.id} className={`${i % 2 === 0 ? "bg-white" : "bg-gray-800"} ${selectedIds.has(row.id) ? "ring-1 ring-inset ring-blue-400" : ""}`}>
                ...
                <td className="px-2 py-1.5 border-r border-gray-700">
                  <div className="flex items-center gap-1.5 mb-0.5">
                    ...
                    <span className="text-[9px] text-gray-800">{row.mesAno ?? ""}</span>
                  </div>
                  <div className="text-[11px] text-white font-medium whitespace-nowrap">{row.nomeAgente ?? "-"}</div>
                </td>
                {/* Coluna Operação */}
                <td className="px-2 py-1.5 border-r border-gray-700">
                  <div className="font-mono text-[11px] text-gray-800 font-medium">{row.proposta ?? "-"}</div>
                  <div className="text-[10px] text-gray-800 whitespace-nowrap">{row.data ?? ""}</div>
                  {row.segmento && (
                ...
                <td className="px-2 py-1.5 border-r border-gray-700 text-right whitespace-nowrap">
                  ...
                  <div className="text-[10px] text-gray-800">RBM: {fmtMoeda(row.rbm)}</div>
                  {row.parcLiberada && <div className="text-[10px] text-gray-800">Parc: {row.parcLiberada}</div>}
                </td>
                {/* Coluna Comissão */}
                <td className="px-2 py-1.5 border-r border-gray-700 text-right whitespace-nowrap">
                  {parseFloat(row.comissao ?? '0') > 0 ? (
                    <>
                      ...
                      <div className="text-[10px] text-gray-800">{fmtPct(row.pctComissao2)}</div>
                    </>
                  ) : (
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div className="text-xs text-gray-800 mt-1">Adiciona somente registros novos. Ignora propostas já existentes.</div>
              </button>
              <button
              ...
              >
                ...
                <div className="text-xs text-gray-800 mt-1">Adiciona novos e atualiza os existentes pelo número da proposta.</div>
              </button>
            </div>
            ...
            <div>
              ...
              />
              {importFileName && (
                <p className="text-xs text-gray-800 mt-1">📄 {importFileName} — {importRows.length} registros lidos</p>
              )}
            </div>
          ...
          <div className="space-y-4 max-h-[75vh] overflow-y-auto pr-1">
            ...
            <div className="p-4 border rounded-lg bg-green-50 border-green-200">
              ...
              <div className="grid grid-cols-6 gap-2 items-end">
                {/* % Demais */}
                <div>
                  <Label className="text-xs text-gray-800">% Demais</Label>
                  <div className="relative">
                    ...
                    <span className="absolute right-2 top-2 text-xs text-gray-800">%</span>
                  </div>
                </div>
                {/* Parc. Demais De */}
                <div>
                  <Label className="text-xs text-gray-800">Parc. Demais De</Label>
                ...
                {/* Parc. Demais Até */}
                <div>
                  <Label className="text-xs text-gray-800">Até</Label>
                ...
                {/* % Imóvel */}
                <div>
                  <Label className="text-xs text-gray-800">% Imóvel</Label>
                  <div className="relative">
                ...
                {/* Parc. Imóvel De */}
                <div>
                  <Label className="text-xs text-gray-800">Parc. Imóvel De</Label>
            ...
            <div className="p-4 border rounded-lg bg-blue-900/20 border-blue-200">
              ...
              <div className="mt-3">
                <Label className="text-xs text-gray-800">Agentes com comissão especial (ChaveJ, um por linha)</Label>
                <textarea
                ...
                />
                <p className="text-xs text-gray-800 mt-1">Digite um ChaveJ por linha. Esses agentes usarão as taxas especiais no cálculo.</p>
              </div>
            </div>
          </div>
          <DialogFooter>
