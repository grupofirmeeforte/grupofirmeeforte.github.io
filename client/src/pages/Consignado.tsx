    ...
    reader.onload = (evt) => {
      try {
        ...
        const colMap: Record<string, keyof FormData> = {
          'empresa': 'empresa', 'mes': 'mes', 'chave j': 'chaveJ', 'chave_j': 'chaveJ',
          'nome agente': 'nomeAgente', 'convenio': 'convenio',
          'nr operacao': 'nrOperacao', 'nr  operacao': 'nrOperacao', 'valor bruto': 'valorBruto',
          'vr liquido': 'valorLiquido', 'valor liquido': 'valorLiquido', 'rbm': 'rbm',
          'parcela': 'parcela', 'prefixo bb': 'prefixoBB', 'dt contratacao': 'dtContratacao',
          'produto': 'produto', 'descricao produto': 'descricaoProduto', 'juros': 'juros',
          'tabela mes': 'tabelaMes', 'perc  a vista': 'percAVista', 'perc a vista': 'percAVista',
          'restricao srcc': 'restricaoSRCC', 'perc  pago': 'percPago', 'perc pago': 'percPago',
          'total comissao': 'totalComissao', 'dif  empresa': 'difEmpresa', 'dif empresa': 'difEmpresa',
          'tabela': 'tabela', 'supervisor': 'supervisor',
        };
