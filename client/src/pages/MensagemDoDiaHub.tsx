...
function AbaVersiculos() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      ...
      <p className="text-center text-slate-800 text-xs mt-6">O versículo muda automaticamente a cada novo dia</p>
    </div>
  );
}
...
function AbaSalmos() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      ...
      <p className="text-center text-slate-800 text-xs mt-6">O salmo muda automaticamente a cada novo dia</p>
    </div>
  );
}
        ...
        <CardContent className="p-10 text-center bg-white">
          {isLoading ? (
            <div className="flex flex-col items-center gap-4 py-8">
              ...
              <p className="text-slate-800">Carregando reflexão...</p>
            </div>
          ) : pensamento ? (
            <>
              ...
              <p className="text-xs text-slate-800 italic mb-2">C. Torres Pastorino — <em>Minutos de Sabedoria</em></p>
              {total != null && total > 0 && <p className="text-xs text-slate-800 mt-1">{total} pensamento{total !== 1 ? 's' : ''} disponíve{total !== 1 ? 'is' : 'l'}</p>}
            </>
          ) : (
            <div className="flex flex-col items-center gap-4 py-8">
        ...
        <CardContent className="p-10 text-center">
          {isLoading ? (
            <div className="flex flex-col items-center gap-4 py-8">
              ...
              <p className="text-slate-800">Carregando sua mensagem do dia...</p>
            </div>
          ) : mensagem ? (
            <>
            ...
            <div className="flex flex-col items-center gap-4 py-8">
              ...
              <p className="text-slate-800">Nenhuma mensagem disponível no momento.</p>
            </div>
          )}
        </CardContent>
      </Card>
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 space-y-6">
      ...
      <div className="bg-gray-900 rounded-2xl shadow-md p-4">
        <p className="text-xs font-bold text-slate-800 uppercase tracking-wider mb-3 text-center">Escolha seu Orixá</p>
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-800 capitalize">{new Date().toLocaleDateString('pt-BR', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>
                </div>
              </div>
