      ...
      <div className="w-[90%] mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <Card className="bg-slate-800 border-slate-700">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-slate-900 text-xs">Total Contratos</p>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-slate-900 text-xs">Elegíveis Refin</p>
          ...
          <Card className="bg-slate-800 border-slate-700 cursor-pointer hover:bg-slate-750 transition-colors" onClick={() => setShowContatosDetalhe(v => !v)}>
            <CardContent className="p-4">
              <div className="flex items-center gap-3 mb-1">
                ...
                <div>
                  <p className="text-slate-900 text-xs">Contatos Realizados</p>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-slate-900 text-xs">Com Erro</p>
        ...
        {aba === 'upload' && (
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent>
              ...
              >
                <Upload className="w-12 h-12 text-slate-900 mx-auto mb-4" />
                <p className="text-white font-medium text-lg mb-1">Arraste os PDFs aqui ou clique para selecionar</p>
                <p className="text-slate-900 text-sm">Suporta múltiplos arquivos — contratos BB Consignado</p>
                <input
                  ref={fileInputRef}
                  type="file"
                  accept=".pdf"
        ...
        {aba === 'relatorio' && (
          <div>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-3 mb-4">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-9 bg-slate-800 border-slate-600 text-white placeholder:text-slate-900"
                />
              </div>
              <Input
                ...
                className="bg-slate-800 border-slate-600 text-white placeholder:text-slate-900"
              />
              <Input
                placeholder="Cidade..."
                value={filtroCidade}
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-slate-800 border-slate-600 text-white placeholder:text-slate-900 font-mono"
                  maxLength={4}
                />
            ...
            {isLoading ? (
              <div className="text-center py-12 text-slate-900">Carregando contratos...</div>
            ) : rows.length === 0 ? (
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="bg-slate-950 text-[9px] uppercase font-bold">
                      ...
                      <th className="px-2 py-1 text-center text-slate-900 border-b border-slate-700 border-l border-slate-700">&nbsp;</th>
                    </tr>
                    <tr className="bg-slate-900 text-slate-900 text-[10px] uppercase">
                    ...
                    {rows.map((r: any, i: number) => {
                      ...
                      <tr key={r.id} className={`border-t border-slate-700 transition-colors hover:bg-blue-900/20 ${i % 2 === 0 ? 'bg-slate-800/40' : 'bg-slate-900/60'}`}>
                        ...
                        <td className="px-2 py-1.5 border-l border-slate-700 border-r border-slate-700/50">
                          ...
                          <div className="text-slate-900 text-[10px] truncate" title={r.nomeConvenio ?? ''}>{r.nomeConvenio ?? '—'}</div>
                        ...
                        <td className="px-2 py-1.5 border-l border-slate-700 border-r border-slate-700/50">
                          ...
                          <div className="flex items-center gap-1 flex-wrap">
                            <span className="text-slate-900 font-mono text-[10px] truncate">{r.cpfCliente ?? '—'}</span>
                            {r.cpfCliente && (
                              <button
                                title="Copiar CPF"
                        ...
                        <td className="px-2 py-1.5 border-l border-slate-700 border-r border-slate-700/50">
                          <div className="flex gap-2 items-baseline">
                            ...
                            <span className="text-slate-900 text-[10px]">{r.prazoMeses ? `${r.prazoMeses}m` : ''}</span>
                          </div>
                            ...
                            >
                              {(r as any).telefones?.length > 0 ? (
                                <div className="flex flex-col gap-0.5">
                                  ...
                                  <span className="text-slate-600 text-[9px] group-hover/tel:text-slate-900 flex items-center gap-0.5"><Pencil className="w-2.5 h-2.5" /> editar</span>
                                </div>
                              ) : (
            ...
            {(data?.total ?? 0) >= 50 && (
              <div className="flex justify-center gap-2 mt-4">
                ...
                <span className="px-4 py-2 text-slate-900 text-sm">Pág. {page}</span>
        ...
        {aba === 'crm' && (
          <div>
            ...
            {isLoading ? (
              <div className="text-center py-12 text-slate-900">Carregando...</div>
            ) : (
                    ...
                    <Card key={r.id} className="bg-slate-800 border-emerald-700/50">
                      <CardContent className="p-4">
                        <div className="flex flex-wrap gap-4 items-start justify-between">
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span className="text-slate-900 text-xs font-mono">#{r.numeroProposta}</span>
                            </div>
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-slate-900 text-xs">Taxa contratada</p>
                        ...
                        <div className="mt-3 pt-3 border-t border-slate-700 flex flex-wrap gap-3 items-center">
                          <div>
                            <p className="text-slate-900 text-xs">Convênio</p>
                            <p className="text-slate-900 text-sm">{r.nomeConvenio ?? '—'}</p>
                          </div>
                          <div>
                            <p className="text-slate-900 text-xs">Operador</p>
                            <p className="text-slate-900 text-sm">{r.nomeOperador ?? r.chaveJOperador ?? '—'}</p>
                          </div>
                          <div>
                            <p className="text-slate-900 text-xs">1ª Parcela</p>
                            <p className="text-slate-900 text-sm">{r.dataPrimeiraParcela ?? '—'}</p>
                          </div>
                          <div>
                            <p className="text-slate-900 text-xs">Últ. Parcela</p>
                            <p className="text-slate-900 text-sm">{r.dataUltimaParcela ?? '—'}</p>
                        ...
                        >
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-slate-900 text-xs">Resultado do contato</span>
                            {r.dataContatoCrm && (
                              <span className="text-slate-500 text-xs">· {r.dataContatoCrm}</span>
                            )}
                            <span className="text-slate-600 text-xs group-hover:text-slate-900 transition-colors ml-auto">✏️ clique para anotar</span>
                          </div>
                          {r.anotacaoCrm ? (
            ...
            <div className="grid grid-cols-2 gap-3">
              {([
                ...
                <div key={campo} className={campo === 'telefoneManuais' ? 'col-span-2' : ''}>
                  <label className="text-slate-900 text-xs mb-1 block">{label}</label>
                  <Input
              ...
              <div className="col-span-2">
                <label className="text-slate-900 text-xs mb-1 block">Situação Manual</label>
                <select
        ...
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-emerald-700 rounded-2xl p-6 w-full max-w-md">
            ...
            <div className="space-y-3">
              <div>
                <label className="text-slate-900 text-xs mb-1 block">Data do contato</label>
                <Input
                  type="date"
              ...
              <div>
                <label className="text-slate-900 text-xs mb-1 block">Anotação / Resultado</label>
                <textarea
      ...
      {deletandoId !== null && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-red-800 rounded-2xl p-6 w-full max-w-sm">
            ...
            <p className="text-slate-900 text-sm mb-4">Esta ação é irreversível. Digite sua senha para confirmar.</p>
            <label className="text-slate-900 text-xs mb-1 block">Senha CEO</label>
            <Input
              type="password"
              value={senhaCeo}
