...
export default function Calculo() {
  ...
  return (
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="px-3 py-1 text-[10px] text-gray-700">{registros.length} registro(s){selecionados.size > 0 && <span className="ml-2 text-purple-400 font-medium">· {selecionados.size} selecionado(s)</span>}</div>
        ...
        <div className="flex flex-wrap items-end gap-4">
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-slate-700 whitespace-nowrap">Mês ant.: <strong className="text-slate-600">{getMesAnterior()}</strong></span>
            </div>
          </div>
          <div className="flex flex-col">
              ...
              {(registros as any[]).map((r, idx) => (
                ...
                >
                  ...
                  <td className="px-2 py-1 border-b border-slate-200 align-top text-right">
                    ...
                    <div className="text-[9px] text-slate-700 mb-0.5">Créd/Déb</div>
            ...
            <table className="w-full text-[10px] border-collapse">
              ...
              <tbody>
                {registrosFiltradosEnvio.length === 0 ? (
                  <tr><td colSpan={7} className="px-2 py-4 text-center text-slate-700">Nenhum registro com os filtros atuais</td></tr>
                ) : (
