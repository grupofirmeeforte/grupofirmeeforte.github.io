...
export default function Calculo() {
  ...
  return (
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="px-3 py-1 text-[10px] text-gray-900">{registros.length} registro(s){selecionados.size > 0 && <span className="ml-2 text-purple-400 font-medium">· {selecionados.size} selecionado(s)</span>}</div>
        ...
        <div className="flex flex-wrap items-end gap-4">
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-slate-900 whitespace-nowrap">Mês ant.: <strong className="text-slate-600">{getMesAnterior()}</strong></span>
            </div>
          </div>
          <div className="flex flex-col">
              ...
              {(registros as any[]).map((r, idx) => (
                ...
                >
                  ...
                  <td className="px-2 py-1 border-b border-slate-200 align-top overflow-hidden">
                    ...
                    {r.tipoPagamento && <div className="text-[9px] text-slate-900 mt-0.5">{r.tipoPagamento}</div>}
                  </td>
                  {/* Célula compacta RBM */}
                  ...
                  <td className="px-2 py-1 border-b border-slate-200 align-top text-right">
                    ...
                    {r.percentual && parseFloat(String(r.percentual)) !== 0 && <div className="text-[10px] text-slate-900">{fmtPerc(r.percentual)}</div>}
                  ...
                  <td className="px-2 py-1 border-b border-slate-200 align-top text-right">
                    ...
                    {r.qtdeContas && String(r.qtdeContas) !== '0' && <div className="text-[10px] text-slate-900">Contas: {r.qtdeContas}</div>}
                    {/* Dt Pagto editável */}
                  ...
                  <td className="px-2 py-1 border-b border-slate-200 align-top text-right">
                    ...
                    <div className="text-[9px] text-slate-900 mb-0.5">Créd/Déb</div>
                    {editandoCreditoDebito === r.id ? (
                      ...
                      <span
                        ...
                        className="cursor-pointer hover:bg-pink-100 rounded px-1 py-0.5 min-w-[5rem] inline-block text-right border border-transparent hover:border-pink-300 text-xs font-medium text-slate-900"
            ...
            <table className="w-full text-[10px] border-collapse">
              ...
              <tbody>
                {registrosFiltradosEnvio.length === 0 ? (
                  <tr><td colSpan={7} className="px-2 py-4 text-center text-slate-900">Nenhum registro com os filtros atuais</td></tr>
                ) : (
