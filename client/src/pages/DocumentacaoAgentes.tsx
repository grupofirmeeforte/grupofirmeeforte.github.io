                    ...
                    docsFiltrados.map((doc, i) => (
                      <tr key={doc.id} className={i % 2 === 0 ? 'bg-gray-900' : 'bg-gray-800'}>
                        <td className="px-4 py-3">
                          <span className={`px-2 py-1 rounded-full text-xs font-semibold ${CORES_TIPO[doc.tipoDocumento] ?? 'bg-gray-100 text-gray-400'}`}>
                            {doc.tipoDocumento}
                          </span>
                        </td>
                        <td className="px-4 py-3">
          ...
          return (
            <div className="space-y-3">
              <div className="flex flex-wrap gap-2 text-sm">
                <span className={`px-2 py-1 rounded text-xs font-semibold ${CORES_TIPO[docVisualizar.tipoDocumento] ?? 'bg-gray-100 text-gray-400'}`}>
