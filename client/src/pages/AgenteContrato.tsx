  ...
  return (
    <div className="contrato-texto text-sm text-gray-900 leading-relaxed">
      ...
      <div className="mt-12 grid grid-cols-2 gap-16">
        <div className="text-center">
          <div className="border-t border-gray-800 pt-2">
            ...
            <p className="text-xs text-gray-800">Contratante</p>
          </div>
        </div>
        <div className="text-center">
          <div className="border-t border-gray-800 pt-2">
            ...
            <p className="text-xs text-gray-800">Contratado(a)</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-10 grid grid-cols-2 gap-16">
        <div className="text-center">
          <div className="border-t border-gray-800 pt-2">
            ...
            <p className="text-xs text-gray-800">Testemunha 1</p>
          </div>
        </div>
        <div className="text-center">
          <div className="border-t border-gray-800 pt-2">
            ...
            <p className="text-xs text-gray-800">Testemunha 2</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-10 border-t-2 border-gray-400 pt-4">
        ...
        <div className="text-right text-xs text-gray-800 mb-6">
  ...
  return (
    <div className="contrato-texto text-sm text-gray-900 leading-relaxed">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-xs mt-2 text-gray-800">Firme &amp; Forte Ltda — CNPJ: 32.828.962/0001-20</p>
        <p className="text-xs text-gray-800">Rua 24 de Outubro nº 283, Centro, Barreiras-BA — CEP: 47800-041</p>
      </div>
...
export default function AgenteContrato() {
  ...
  if (isLoading) {
    return <div className="flex items-center justify-center h-64 text-gray-800">Carregando contrato...</div>;
  }

  if (!agente) {
    return <div className="flex items-center justify-center h-64 text-gray-800">Agente não encontrado.</div>;
  }
      ...
      <div className="max-w-4xl mx-auto bg-gray-900 border border-gray-700-lg print:shadow-none my-6 print:my-0 p-10 print:p-8">
        {!tipoContrato ? (
          <div className="text-center py-16">
            <p className="text-lg font-semibold text-gray-800 mb-2">Empresa não identificada para geração de contrato</p>
        ...
        {/* Rodapé */}
        {tipoContrato && (
          <div className="mt-8 pt-4 border-t border-gray-700 text-xs text-gray-800 text-center print:hidden">
