            ...
            {rows.length === 0 ? (
              ...
              <tr key={`${row._fonte}-${row.id}`}
                ...
                <td className="px-2 py-1.5 whitespace-nowrap">
                  ...
                  {(row as any).favorecidoAgente && <div className="text-[14px] text-green-400 font-medium truncate max-w-[220px]" title={(row as any).favorecidoAgente}>{(row as any).favorecidoAgente}</div>}
