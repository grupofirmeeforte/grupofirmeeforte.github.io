...
function PosicaoIcon({ pos }: { pos: number }) {
  ...
  return <span className="text-lg font-bold text-slate-700">#{pos}</span>;
}
        ...
        <DialogContent className="bg-slate-800 border-slate-700 text-white">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Ex: 5000"
              className="bg-slate-700 border-slate-600 text-white placeholder:text-slate-700"
              autoFocus
            />
          </div>
      ...
      {isLoading ? (
        <div className="flex items-center justify-center py-32">
          <div className="text-center">
            ...
            <p className="text-slate-700">Carregando seu painel...</p>
          </div>
        </div>
      ) : (
        <div className="max-w-6xl mx-auto px-4 py-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card className="md:col-span-2 border-0 bg-slate-800/80 text-white shadow-xl">
              <CardContent className="p-6 flex items-center gap-4">
                ...
                <div>
                  <p className="text-slate-700 text-sm">Bem-vindo de volta,</p>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-slate-700 text-xs">{painel?.agente?.cidade}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                {metaTotal > 0 ? (
                      ...
                      <>
                        <div className="flex justify-between items-end">
                          <div>
                            ...
                            <div className="text-slate-700 text-xs">de {fmt(metaTotal)}</div>
                          </div>
                  ...
                  <div className="text-center py-6">
                    ...
                    <p className="text-slate-700 text-sm">Nenhuma meta definida</p>
                    <Button
                      size="sm"
          ...
          <Card className="border-0 bg-slate-800/80 text-white shadow-xl">
            ...
            <CardContent>
              {rankLoading ? (
                <div className="text-center py-8 text-slate-700">Carregando ranking...</div>
              ) : !ranking || ranking.length === 0 ? (
                <div className="text-center py-8 text-slate-700">Nenhum dado disponível para este mês.</div>
              ) : (
                  ...
                  {(() => {
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-slate-700">{r.cidade}</div>
                      </div>
              ...
              <CardContent>
                {!painel?.conquistas || painel.conquistas.length === 0 ? (
                  <div className="text-center py-6">
                    ...
                    <p className="text-slate-700 text-sm">Nenhuma conquista ainda. Continue acessando!</p>
                  </div>
                ) : (
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                  {painel.historico.map((h, i) => (
                    <div key={h.mesRef ?? (h as any).mes_ref} className="bg-slate-700/50 rounded-lg p-3 text-center">
                      <div className="text-slate-700 text-xs mb-1">{h.mesRef ?? (h as any).mes_ref}</div>
