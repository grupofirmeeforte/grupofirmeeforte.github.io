    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-4">
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              {busca && (
                <button
                  onClick={limpar}
                  className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-900 hover:text-gray-900"
                >
                  <X className="w-4 h-4" />
                </button>
              )}
        ...
        <div className="bg-gray-900 rounded-xl border border-gray-700 shadow-sm overflow-hidden">
          <div className="grid grid-cols-[120px_1fr] bg-gray-800 px-4 py-2 text-xs font-semibold text-gray-900 uppercase tracking-wider border-b border-gray-700">
            <span>Prefixo</span>
            ...
            <div className="divide-y divide-gray-800">
              {agencias.map((ag, idx) => (
                ...
                >
                  ...
                  <span className="text-gray-900">{ag.nome}</span>
                </div>
              ))}
            </div>
          )}
          ...
          {!isLoading && agencias.length > 0 && (
            <div className="px-4 py-2 bg-gray-800 border-t border-gray-700 text-xs text-gray-900 flex justify-between">
              <span>
                {busca.trim()
